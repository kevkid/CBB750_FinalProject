...
#        pass
    ...
    def __init__(self):
        pass
    def set_rxnorm(self,rxnorm_list):
        rxnorm = list(itertools.chain.from_iterable(rxnorm_list)) # Flatten into one list
        ...
        return (rxcui_counts, rxcui_unique)
    
    def build_rxnorm_dict(self, rxcui_counts, rxcui_unique):
